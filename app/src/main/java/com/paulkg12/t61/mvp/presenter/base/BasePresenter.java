...
import com.paulkg12.t61.http.CommitService;
import com.paulkg12.t61.http.IssueService;
import com.paulkg12.t61.http.LoginService;
import com.paulkg12.t61.AppConfig;
import com.paulkg12.t61.http.UserService;
import com.paulkg12.t61.http.core.AppRetrofit;
...
import com.paulkg12.t61.http.error.HttpError;
import com.paulkg12.t61.http.error.HttpErrorCode;
import com.paulkg12.t61.http.error.HttpPageNoFoundError;
import com.paulkg12.t61.http.error.UnauthorizedError;
    ...
    public void detachView() {
        ...
        for (Subscriber subscriber : subscribers) {
            if (subscriber != null && !subscriber.isUnsubscribed()) {
                ...
                Log.d(TAG, "unsubscribe:" + subscriber.toString());
            }
        }
