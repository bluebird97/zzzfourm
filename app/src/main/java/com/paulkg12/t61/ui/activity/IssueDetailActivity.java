...
import com.paulkg12.t61.mvp.presenter.IssueDetailPresenter;
 ...
 */
// TODO: 2020/3/15  tt 接下来搞我，better animation！and show!
public class IssueDetailActivity extends BaseActivity<IssueDetailPresenter>
    ...
    public void showIssue(final Issue issue) {
        setToolbarTitle(getString(R.string.issue_topic).concat(" #").concat(String.valueOf(issue.getNumber())));
